  ...
  onShare = async () => {
    try {
      const result = await Share.share({
        message: "Salah App  , Link: https://bit.ly/2Vazqat ",
      });
    ...
    return (
      <>
        <View style={{ backgroundColor: "white", height: height }}>
          ...
          {this.modalView()}
          <TouchableOpacity
            onPress={() => this.props.navigateFunc("About")}
            style={{
              backgroundColor:
                this.props.currentScreen == "About" ? "grey" : null,
              flexDirection: "row",
              marginLeft: 20,
              marginTop: 20,
            }}
          ...
          >
            ...
            <Text
              style={{ height: height * 0.07, marginLeft: 20, fontSize: 17 }}
            >
              Share
            </Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity
            onPress={() => this.props.navigateFunc("Privacy")}
            style={{
              backgroundColor:
                this.props.currentScreen == "Privacy" ? "grey" : null,
              flexDirection: "row",
              marginLeft: 20,
            }}
          >
          ...
          <TouchableOpacity
            onPress={() => this.props.navigateFunc("Contact")}
            style={{ flexDirection: "row", marginLeft: 20 }}
          >
            <MaterialIcons
              name={"quick-contacts-mail"}
          ...
          <TouchableOpacity
            onPress={() =>
              Linking.openURL(
                "https://play.google.com/store/apps/details?id=com.namazapp"
              )
            }
            style={{ flexDirection: "row", marginLeft: 20 }}
          >
            <EvilIcons name={"star"} size={25} color={"black"} />
            <Text
              style={{ height: height * 0.07, marginLeft: 20, fontSize: 17 }}
            >
              Rate Us
